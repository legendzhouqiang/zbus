...
ZBOX_EXPORT int base64_encode( unsigned char *dst, size_t *dlen, const unsigned char *src, size_t slen );
ZBOX_EXPORT int base64_decode( unsigned char *dst, size_t *dlen, const unsigned char *src, size_t slen );
ZBOX_EXPORT json_t *json_base64str(byte *bin, size_t len); 
ZBOX_EXPORT byte* json_base64bin(json_t* json, size_t *len);
