...
//add by wanp 增加win版重加密函数
#if defined(OS_IS_WINDOWS)
//extern "C" _declspec(dllexport) int w2kbss_reencrypt(char *p_pszOutput, int p_nFixedSize, const char *p_pszInput, const char *p_pszOldKey, const char *p_pszNewKey);
typedef int (*PFUN_KDReEncode)(char *p_pszOutput, int p_nFixedSize, const char *p_pszInput, const char *p_pszOldKey, const char *p_pszNewKey);
#endif
...
void DLLEXPORT CALLTYPE AES_Encrypt1(char *p_pszEncrResult, int p_iSize, long long p_llKey, const char * p_pszEncrInfo);
void DLLEXPORT CALLTYPE AES_Decrypt1(char *p_pszDecrResult, int p_iSize, long long p_llKey, const char * p_pszDecrInfo);
...
void DLLEXPORT CALLTYPE RC5_Encrypt1(char * p_pszEnResult, int p_iSize, long long p_llKey, const char * p_pszEnInfo);
void DLLEXPORT CALLTYPE RC5_Decrypt1(char * p_pszDeResult, int p_iSize, long long p_llKey, const char * p_pszDeInfo);
