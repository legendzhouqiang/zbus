...
public interface AsyncCallback {
    ...
    interface StatCallback extends AsyncCallback {
         ...
         * <p/>
         * On success, rc is
         * {@link org.zbus.zookeeper.KeeperException.Code#OK}.
         * <p/>
         * On failure, rc is set to the corresponding failure code in
         * {@link org.zbus.zookeeper.KeeperException}.
         * <ul>
         * <li>
         * {@link org.zbus.zookeeper.KeeperException.Code#NONODE}
         * - The node on given path doesn't exist for some API calls.
         * </li>
         * <li>
         * {@link org.zbus.zookeeper.KeeperException.Code#BADVERSION}
         ...
         *             asynchronous calls.
         * @param stat {@link org.zbus.zookeeper.data.Stat} object of
    ...
    interface DataCallback extends AsyncCallback {
         ...
         * @param ctx  Whatever context object that we passed to
         *             asynchronous calls.
         * @param data The {@link org.zbus.zookeeper.server.DataNode#data}
         *             of the node.
         * @param stat {@link org.zbus.zookeeper.data.Stat} object of
         *             the node on given path.
         */
    ...
    interface ACLCallback extends AsyncCallback {
         ...
         *             asynchronous calls.
         * @param acl  ACL Id in
         *             {@link org.zbus.zookeeper.ZooDefs.Ids}.
         * @param stat {@link org.zbus.zookeeper.data.Stat} object of
         *             the node on given path.
         */
    ...
    interface Children2Callback extends AsyncCallback {
        /**
         * Process the result of the asynchronous call.
         * See {@link org.zbus.zookeeper.AsyncCallback.ChildrenCallback}.
         *
         * @param rc       The return code or the result of the call.
         * @param path     The path that we passed to asynchronous calls.
         * @param ctx      Whatever context object that we passed to
    ...
    interface StringCallback extends AsyncCallback {
         ...
         * <ul>
         * <li>
         * {@link org.zbus.zookeeper.KeeperException.Code#NODEEXISTS}
         ...
         * <li>
         * {@link
         * org.zbus.zookeeper.KeeperException.Code#NOCHILDRENFOREPHEMERALS}
     ...
     * org.zbus.zookeeper.ZooKeeper#sync(String,
     * org.zbus.zookeeper.AsyncCallback.VoidCallback, Object)}.
     */
    interface VoidCallback extends AsyncCallback {
         ...
         * </li>
         * <li>
         * {@link org.zbus.zookeeper.KeeperException.Code#NOTEMPTY}
         * - the node has children and some API calls cannnot succeed,
         * e.g. {@link
         * org.zbus.zookeeper.ZooKeeper#delete(String, int,
         * org.zbus.zookeeper.AsyncCallback.VoidCallback, Object)}.
         * </li>
         * </ul>
         *
     ...
     * a single multi call.
     * See {@link org.zbus.zookeeper.ZooKeeper#multi} for more information.
     * @since 3.4.7
     */
    interface MultiCallback extends AsyncCallback {
         ...
         * {@link org.zbus.zookeeper.KeeperException.Code#OK}.
         * All opResults are
         * non-{@link org.zbus.zookeeper.OpResult.ErrorResult},
         *
         * <p/>
         * On failure, rc is a failure code in
         * {@link org.zbus.zookeeper.KeeperException.Code}.
         * All opResults are
         * {@link org.zbus.zookeeper.OpResult.ErrorResult}.
