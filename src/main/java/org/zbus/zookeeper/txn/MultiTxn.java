...
public class MultiTxn implements Record {
  ...
  public MultiTxn(
        java.util.List<org.zbus.zookeeper.txn.Txn> txns) {
    this.txns=txns;
  }
  public java.util.List<org.zbus.zookeeper.txn.Txn> getTxns() {
    return txns;
  }
  public void setTxns(java.util.List<org.zbus.zookeeper.txn.Txn> m_) {
    txns=m_;
  }
    ...
    a_.startRecord(this,tag);
    {
      ...
      if (txns!= null) {          int len1 = txns.size();
          for(int vidx1 = 0; vidx1<len1; vidx1++) {
            org.zbus.zookeeper.txn.Txn e1 = (org.zbus.zookeeper.txn.Txn) txns.get(vidx1);
  ...
  public void deserialize(InputArchive a_, String tag) throws java.io.IOException {
    a_.startRecord(tag);
    {
      ...
      if (vidx1!= null) {          txns=new java.util.ArrayList<org.zbus.zookeeper.txn.Txn>();
          for (; !vidx1.done(); vidx1.incr()) {
    org.zbus.zookeeper.txn.Txn e1;
    e1= new org.zbus.zookeeper.txn.Txn();
    a_.readRecord(e1,"e1");
            txns.add(e1);
          }
      }
